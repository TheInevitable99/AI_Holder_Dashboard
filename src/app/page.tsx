  ...
  },
  {
    ...
    image: "https://media.gettyimages.com/id/909222638/vector/alien-planets-in-orbit-around-a-dyson-sphere.jpg?s=1024x1024&w=gi&k=20&c=zWmBXHVFCaq5XlIvfXQdtlGclM0ChcOCQAxs1lWdno0=",
     ...
     { id: 3, 
      ...
      date: "2025-01-24", 
      model: "Terra", 
      image: "https://img.freepik.com/premium-photo/portrait-creepy-humanoid-alien-created-with-generative-ai_419341-3055.jpg" 
     },
  { id: 4, 
   title: "Extraterrestrial ",
   date: "2025-01-23", 
   model: "Aqua", 
   image: "https://imgcdn.stablediffusionweb.com/2024/3/17/e0b14600-c0b4-4e62-9dcb-8e6367d74110.jpg"
  },
  { id: 5,
   title: "WARMACHINE ", 
   date: "2025-01-22", 
